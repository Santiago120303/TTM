...
<head>
  <!-- ** Basic Page Needs ** -->
  <meta charset="utf-8" />
  <title>Recuperar contraseña - TTM</title>
          ...
          <div class="border">
            ...
            <form action="../../Controllers/generarClave.php" method="POST">
              <fieldset class="p-4">
                ...
                <input class="form-control mb-3" type="text" placeholder="Ej:80749473" name="id_user" require>
                <label>Correo electrónico</label> 
                <input class="form-control mb-3" type="email" placeholder="Ej:ejemplo@gmail.com" name="email" require>
