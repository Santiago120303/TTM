        ...
        <div class="col-lg-9">
          ...
          <section id="main-content">
            <div class="widget dashboard-container my-adslist">
              <h3 class="widget-header">Actulización de Información de la Fundación</h3>
              <a class="d-block w-100 text-right font-weight-bold" href="home.php"><i class="fa-solid fa-arrow-left mr-2"></i>Volver</a>
              <div class="row">
